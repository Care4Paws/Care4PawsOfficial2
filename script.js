...
const bannedWords = [
  ...
  'μαλάκας', 'πούστης', 'καριόλης', 'γαμιέσαι', 'μουνί', 'αρχίδι', 'πουτάνα', 'γαμώτο','nigger','diddy','brainrot','k-pop','front man','kpop','παιδέρας','παιδεραστής','cock','balls','πούστης','Λοατκι'
];
